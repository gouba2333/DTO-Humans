CHECKPOINT_PATH='ckpt/camerahmr_checkpoint_cleaned.ckpt'
CAM_MODEL_CKPT='ckpt/cam_model_cleaned.ckpt'
DENSEKP_CKPT='ckpt/densekp.ckpt'
SMPL_MEAN_PARAMS_FILE='data/models/smpl/smpl_mean_params.npz'
SMPL_MODEL_PATH='data/models/smpl/SMPL_NEUTRAL.pkl'
DETECTRON_CKPT='ckpt/model_final_f05665.pkl'

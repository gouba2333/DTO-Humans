...
Run the DTO framework for each dataset to generate our refined annotations. The results will be saved as `*_opt.npz` in the respective dataset directories. Simple reorgnizing leads to `*_CHMR_SMPL_OPT.npz`
